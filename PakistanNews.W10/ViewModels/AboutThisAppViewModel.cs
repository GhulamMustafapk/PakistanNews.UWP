...
namespace PakistanNews.ViewModels
{
    public class AboutThisAppViewModel : PageViewModelBase
    {
        ...
        {
            this.AppName = "Pakistan News";
            this.Title = "NavigationPaneAbout".StringResource();
            this.Publisher = "Ghulam Mustafa";
            ...
            this.AboutText = "Pakistan News Live,  gives you easy access to read up to the minute news from the" +
    " most popular/Leading news sources. Take this app with you and stay informed wit" +
    "h access to the latest news.";
