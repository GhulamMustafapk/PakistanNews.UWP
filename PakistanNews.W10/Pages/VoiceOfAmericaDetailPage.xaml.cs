//---------------------------------------------------------------------------
//
// <copyright file="VoiceOfAmericaDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class VoiceOfAmericaDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public VoiceOfAmericaDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new VoiceOfAmericaSection());
