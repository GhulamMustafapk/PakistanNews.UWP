//---------------------------------------------------------------------------
//
// <copyright file="SAMAANewsDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class SAMAANewsDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public SAMAANewsDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new SAMAANewsSection());
